defmodule OnslaughtWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(OnslaughtWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(OnslaughtWeb.Gettext, "errors", msg, opts)
    end
  end
